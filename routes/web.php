...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::delete('/like/{post_id}/destory', [LikeController::class, 'destroy'])->name('like.destroy');
    ...
    Route::post('/messages/{user}/store', [MessageController::class, 'store'])->name('message.store');
